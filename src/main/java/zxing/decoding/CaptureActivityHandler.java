  ...
  public void handleMessage(Message message) {
    switch (message.what) {
      ...
      case R.id.restart_preview:
        LogUtils.d(TAG+"Got restart preview message");
        restartPreviewAndDecode();
        break;
      case R.id.decode_succeeded:
        LogUtils.d(TAG+"Got decode succeeded message");
        state = State.SUCCESS;
      ...
      case R.id.return_scan_result:
        LogUtils.d(TAG+"Got return scan result message");
        activity.setResult(Activity.RESULT_OK, (Intent) message.obj);
        activity.finish();
        break;
      case R.id.launch_product_query:
        LogUtils.d(TAG+"Got product query message");
