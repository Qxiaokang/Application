...
import com.example.aozun.testapplication.DateSlider.labeler.Labeler;
import com.example.aozun.testapplication.DateSlider.timeview.TimeView;
...
public class ScrollLayout extends LinearLayout{
    ...
    protected void onFinishInflate() {
        ...
        final int displayWidth =400; display.getWidth();
    ...
    protected void moveElements(int steps) {
        ...
        for (int i = start; i != end; i += incr) {
            ...
            if (index >= 0 && index < getChildCount()) {
            	...
            	long  diff=tv.getEndTime()-tv.getStartTime();
                tv.setVals(mLabeler.add(tv.getEndTime()-diff/2, -steps));
            }
    ...
    public void setDate(long time){
        ...
        mCenterView = (TimeView)getChildAt(centerIndex);
        mCenterView.setVals(mLabeler.getElem(time));
